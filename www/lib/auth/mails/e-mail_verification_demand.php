...
<body style="font-family: Arial, sans-serif; background-color: #f8f8f8;">
	...
	<div id="main" style="background-color:white; margin:0 auto; max-width:600px; padding:20px;">
		...
		<a href="<?=CDN_URL?>/controller/authentication/email_confirmation.php?login=<?=$_SESSION['login']?>&OTP=<?=$_SESSION['login_OTP']?>" title="<?=EMAIL_VERIFICATION_BUTTON?>" style="color:white;">
			<div id="address_confirmation_button" style="width:300px; background-color:#55aaee; text-align:center; margin:0 auto; padding:10px;">
